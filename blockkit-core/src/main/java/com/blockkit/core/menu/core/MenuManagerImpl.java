package com.blockkit.core.menu.core;

import com.blockkit.BlockKit;
import com.blockkit.api.menu.MenuManager;
import com.blockkit.core.menu.listener.MenuListener;
...
public class MenuManagerImpl implements MenuManager {
    ...
    public void register(Inventory inv, Map<Integer, Consumer<InventoryClickEvent>> handlers) {
    ...
    public Map<Integer, Consumer<InventoryClickEvent>> getHandlers(Inventory inv) {
